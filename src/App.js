...
/*
to-do
-look up how to do variable URL and getting a segment of url from the component in note, done
-make the single User component render a list of names of all their blogs, done
-make the all users page prettier
-figure out how to make costum hook works as intended
*/
...
const App = () => {
  ...
  const blogSubHandler = async (blogTitle, blogURL, blogOwner) => {
    ...
    try {
      ...
      toggleRef.current.toggleVisibility()//hide the blog submission form upon successful submission
      subSuccess = true
    }
    catch (error) {
